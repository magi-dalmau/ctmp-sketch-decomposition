...
class NonMonotonicTampProblem : public MoveitTampProblem {
public:
  /*


   */
  NonMonotonicTampProblem(const std::string &filename, const std::string &planning_group, ros::NodeHandle *nodehandle);
