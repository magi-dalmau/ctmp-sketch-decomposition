...
//   }
// }
void ClutteredTampProblem::SetMisplacedObjects(MoveitTampState *const state) const {
  ...
  for (std::size_t i = 0; i < objects_.size(); ++i) {
    ...
    } else if (!goal_region_ && state->GetAttatchedObject() == object_names_.at(i)) {
...
// std::size_t ClutteredTampProblem::BlockingObjects(MoveitTampState const *const state,
